...
const DEFAULT_ANDROID_UA = 'Mozilla/5.0 (Linux; Android 10; Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.162 Mobile Safari/537.36 com.nintendo.znca/3.5.0';
    ...
    const baseRule: chrome.declarativeNetRequest.Rule = {
        ...
        action: {
            ...
            responseHeaders: [
                ...
                { header: 'access-control-allow-methods', operation: chrome.declarativeNetRequest.HeaderOperation.SET, value: 'GET, HEAD, OPTIONS' },
                { header: 'access-control-allow-headers', operation: chrome.declarativeNetRequest.HeaderOperation.SET, value: '*' }
            ]
        },
        condition: {
            requestDomains: ['nintendo.net', 'nintendo.com', 'nintendo.co.jp', 'nintendowifi.net'],
            resourceTypes: [
