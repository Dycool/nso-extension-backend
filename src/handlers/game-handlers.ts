        ...
        try {
            const prewarmRes = await fetch(targetUrl.toString(), {
                headers: {
                    ...
                    'User-Agent': 'Mozilla/5.0 (Linux; Android 10; Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.162 Mobile Safari/537.36 com.nintendo.znca/3.5.0'
                },
                redirect: 'follow'
            });
