<p align="center">
  <img src="icons/icon128.png" alt="CoralWeb Companion icon" width="128" height="128">
</p>

# CoralWeb Companion

**Local zero-worker companion and direct connection engine for [CoralWeb](https://dycool.github.io/nso-webapp).**
